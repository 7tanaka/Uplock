Public Class Instagram
    ...
    Private Sub Instagram_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'InstagramDataSet.instagram' table. You can move, or remove it, as needed.
        Me.InstagramTableAdapter.Fill(Me.InstagramDataSet.instagram)

    End Sub

    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        InstagramBindingSource.AddNew()
        btnAdd.IconColor = Color.FromArgb(74, 74, 76)
        btnAdd.BackColor = Color.FromArgb(214, 214, 0)
    End Sub

    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        InstagramBindingSource.MoveNext()
    ...
    Private Sub btnPrev_Click(sender As Object, e As EventArgs) Handles btnPrev.Click
        InstagramBindingSource.MovePrevious()
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Me.Validate()
        Me.InstagramBindingSource.EndEdit()
        Me.InstagramTableAdapter.Update(Me.InstagramDataSet)
...
Feedback:
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        InstagramBindingSource.RemoveCurrent()
