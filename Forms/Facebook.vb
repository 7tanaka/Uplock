Public Class Facebook
    Private Sub Facebook_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'FacebookDataSet.Facebook' table. You can move, or remove it, as needed.
        Me.FacebookTableAdapter.Fill(Me.FacebookDataSet.Facebook)

    End Sub

    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        FacebookBindingSource.AddNew()
    ...
    Private Sub btnPrev_Click(sender As Object, e As EventArgs) Handles btnPrev.Click
        ...
        FacebookBindingSource.MovePrevious()
    End Sub

    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        FacebookBindingSource.MoveNext()
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Me.Validate()
        Me.FacebookBindingSource.EndEdit()
        Me.FacebookTableAdapter.Update(Me.FacebookDataSet)
...
Feedback:
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        FacebookBindingSource.RemoveCurrent()
