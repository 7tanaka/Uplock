Public Class Riot
    ...
    Private Sub Riot_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'RiotDataSet.riot' table. You can move, or remove it, as needed.
        Me.RiotTableAdapter.Fill(Me.RiotDataSet.riot)

    End Sub

    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        RiotBindingSource.AddNew()
        btnAdd.IconColor = Color.FromArgb(74, 74, 76)
        btnAdd.BackColor = Color.FromArgb(214, 214, 0)
    End Sub

    Private Sub btnPrev_Click(sender As Object, e As EventArgs) Handles btnPrev.Click
        RiotBindingSource.MovePrevious()
        btnPrev.IconColor = Color.FromArgb(74, 74, 76)
        btnPrev.BackColor = Color.FromArgb(214, 214, 0)
    End Sub

    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        RiotBindingSource.MoveNext()
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Me.Validate()
        Me.RiotBindingSource.EndEdit()
        Me.RiotTableAdapter.Update(Me.RiotDataSet)
...
Feedback:
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        RiotBindingSource.RemoveCurrent()
