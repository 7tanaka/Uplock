Public Class Twitter
    ...
    Private Sub Twitter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'TwitterDataSet.twitter' table. You can move, or remove it, as needed.
        Me.TwitterTableAdapter.Fill(Me.TwitterDataSet.twitter)

    End Sub

    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        TwitterBindingSource.AddNew()
    ...
    Private Sub btnPrev_Click(sender As Object, e As EventArgs) Handles btnPrev.Click
        ...
        TwitterBindingSource.MovePrevious()
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Me.Validate()
        Me.TwitterBindingSource.EndEdit()
        Me.TwitterTableAdapter.Update(Me.TwitterDataSet)
...
Feedback:
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        ...
        TwitterBindingSource.RemoveCurrent()
    End Sub
