Public Class PhoneNum
    Private Sub PhoneNum_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'PhoneNumbersDataSet.numbers' table. You can move, or remove it, as needed.
        Me.NumbersTableAdapter.Fill(Me.PhoneNumbersDataSet.numbers)
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Me.NumbersTableAdapter.Update(Me.PhoneNumbersDataSet)
...
Feedback:
    ...
    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        NumbersBindingSource.MoveNext()
    End Sub

    Private Sub btnPrev_Click(sender As Object, e As EventArgs) Handles btnPrev.Click
        NumbersBindingSource.MovePrevious()
