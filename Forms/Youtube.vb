Public Class Youtube
    ...
    Private Sub Youtube_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'YoutubeDataSet.youtube' table. You can move, or remove it, as needed.
        Me.YoutubeTableAdapter.Fill(Me.YoutubeDataSet.youtube)

    End Sub

    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        YoutubeBindingSource.AddNew()
        btnAdd.IconColor = Color.FromArgb(74, 74, 76)
        btnAdd.BackColor = Color.FromArgb(214, 214, 0)
    End Sub

    Private Sub btnPrev_Click(sender As Object, e As EventArgs) Handles btnPrev.Click
        YoutubeBindingSource.MovePrevious()
        btnPrev.IconColor = Color.FromArgb(74, 74, 76)
        btnPrev.BackColor = Color.FromArgb(214, 214, 0)
    End Sub

    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        YoutubeBindingSource.MoveNext()
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Me.Validate()
        Me.YoutubeBindingSource.EndEdit()
        Me.YoutubeTableAdapter.Update(Me.YoutubeDataSet)
...
Feedback:
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        ...
        YoutubeBindingSource.RemoveCurrent()
    End Sub
