Public Class Google
    Private Sub Google_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Me.Validate()
        Me.GoogleBindingSource.EndEdit()
        Me.GoogleTableAdapter.Update(Me.GoogleDataSet)
...
Feedback:
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        GoogleBindingSource.RemoveCurrent()
    ...
    Private Sub Backup_emailTextBox_TextChanged(sender As Object, e As EventArgs) 
